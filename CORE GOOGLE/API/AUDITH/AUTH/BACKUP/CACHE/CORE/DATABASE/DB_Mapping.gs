...
const DB_Mapping = (function () {
  ...
  const TABLES = {
    USUARIOS: ['ID','matricula','nome','email','telefone','cargo','funcao','perfil','status','obraAtual','ambiente','permissoes','dataCadastro','ultimoAcesso','sessaoAtual','biometricId','faceCredentialId','statusBiometria','consentimentoBiometrico','dataConsentimento','dataAtualizacao','senha_hash'],
    ...
    PRODUTOS: ['ID','codigo','codigoBarras','descricaoOriginal','descricaoNormalizada','NCM','unidade','status'],
    ...
    MOVIMENTOS: ['ID','tipo','produtoId','quantidade','origem','destino','responsavel','documentoId','obraId','projetoId','atividadeId','data'],
    RESERVAS: ['ID','produtoId','localizacao','quantidade','solicitante','obraId','status','validade','aprovador','data'],
    SAIDAS: ['ID','tipo','produtoId','localizacao','quantidade','reservaId','responsavel','obraId','status','data'],
    INVENTARIOS: ['ID','token','obraId','localizacao','estado','responsavel','dataAbertura','dataFechamento'],
    CONTAGENS: ['ID','inventarioId','produtoId','esperado','contado','diferenca'],
    ...
    OCORRENCIAS: ['ID','tipo','prioridade','descricao','obraId','projetoId','atividadeId','responsavel','data','status','resolucao'],
    NOTIFICACOES: ['ID','tipo','destinatario','titulo','mensagem','lida','data'],
    AUDITORIA: ['ID','usuario','acao','modulo','entidade','entidadeId','antes','depois','data','hora','ip','origem','resultado','correlationId'],
    BACKUPS: ['ID','data','versao','responsavel','arquivosJson','status'],
    ...
    ETIQUETA: ['ID','tipo','referenciaId','conteudoQR','codigoBarras','tamanho','fonte','geradoEm'],
