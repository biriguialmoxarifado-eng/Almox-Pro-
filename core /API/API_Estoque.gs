...
function buscar_estoque(ctx) {
  return Service_Estoque.buscar(ctx);
}
...
function API_Estoque_registerPermissions() {
  ...
  Auth_RBAC.registerActionPermission('estoque.buscar', 'ESTOQUE.VIEW');
}
